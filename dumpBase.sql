...
--
-- Host: localhost    Database: dbListeCourses
-- ------------------------------------------------------
...
CREATE TABLE `liste` (
  ...
  CONSTRAINT `liste_ibfk_1` FOREIGN KEY (`produitId`) REFERENCES `produit` (`produitId`)
...
INSERT INTO `liste` VALUES (0,1,12),(0,2,10),(0,3,6),(0,4,2),(0,5,2),(0,6,9);
...
-- Dump completed on 2014-03-13 11:14:54
